...
class BackGroundController {
    ...
    func addBackgroundMusic(_ parent: SKNode) {
        parent.run(
            SKAction.sequence([
                SKAction.run({ 
                    if let musicURL = Bundle.main.url(forResource: "backGround_Sound", withExtension: "mp3") {
    ...
    func addBackGround(_ parent: SKNode){
    ...
    func scrollBackGround(_ speed: CGFloat){
